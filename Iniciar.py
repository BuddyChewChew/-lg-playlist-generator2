...
REGIONS = {
    ...
    'en-GB': {'language': 'en', 'prefix': 'lg_channels_en_gb', 'epg_prefix': 'lg_epg_en_gb'},
    'GBR': {'language': 'en', 'prefix': 'lg_channels_gbr', 'epg_prefix': 'lg_epg_gbr'},
    'UK-GB': {'language': 'en', 'prefix': 'lg_channels_uk_gb', 'epg_prefix': 'lg_epg_uk_gb'},
}
